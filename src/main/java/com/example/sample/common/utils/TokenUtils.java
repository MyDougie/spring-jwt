...
public class TokenUtils {
    ...
    private static final String jwtSecretKey = "exampleSecretKey1234567890exampleSecretKey1234567890";
    ...
    public static String generateJwtToken(UserVO userVO) {
        ...
        JwtBuilder builder = Jwts.builder()
                ...
                .setSubject(String.valueOf(userVO.getUserSq()))        // Payload - Subject 구성
    ...
    public static boolean isValidToken(String token) {
        try {
            ...
            log.error("Token is null" + exception.getMessage());
            return false;
        }
    }
    ...
    private static Map<String, Object> createClaims(UserVO userVO) {
        ...
        claims.put("userNm", userVO.getUserNm());
        return claims;
    }
